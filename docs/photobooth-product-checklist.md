...
- [x] Manual 4/6 slot flow: capture -> preview -> OK or Retake.
...
- [ ] Capture slot 1 again, press `Use Photo / OK`, move to `Slot 2/4`.
- [ ] Fill all 4 slots, verify `Apply All` and `Make Strip` become enabled only then.
